...
<%
	...
	try 
	{
		   ...
		   if (myFile.isMissing())
		   {
			  out.println("<script language=javascript>alert('please select IMG！');   history.back(-1);</script>");
			  return;
		   ...
		   else 
		   {
			   ...
			   System.out.println("Image Size："+file_size+"Image Name："+file_name);
               ...
               //{
	               ...
	               System.out.println("New Name："+newFile1Name);
...
<script language="javascript">
    document.write("Succeed,click to Close");
