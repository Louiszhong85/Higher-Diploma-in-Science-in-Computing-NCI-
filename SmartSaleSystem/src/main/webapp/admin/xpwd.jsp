...
<body >
   ...
   <script>alert('${msg}')</script> 
    ...
    <form name="form1" class="form-horizontal" id="form1" method="post" action="<%=path %>/ygpwd">	
...
<div class="layui-form-item">
  <label class="layui-form-label">Re-New:</label>
<div class="layui-input-block">
    <input type="password" name="pwd3"   autocomplete="off" placeholder="New Password" class="layui-input" style="width:300px" required="required" >
  </div>
</div>
