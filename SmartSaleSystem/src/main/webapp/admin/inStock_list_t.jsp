...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend >In Stock Report</legend>
</fieldset>
 <div class="layui-form">
  <xblock style="line-height:50px;height:50px;padding-top:2px; " >
 <form name="form1" id="form1" method="post"  action="<%=path %>/inStocksearlist?ty=t">
...
<div class="layui-form-item" style="line-height:40px;height:40px">
 ...
 <input type="text" name="itemName"   autocomplete="off" placeholder="Item Name" class="layui-input"  >
  ...
  <div class="layui-input-inline">
  <input type="date" name="inDate"   autocomplete="off" placeholder="Date" class="layui-input"  >
   </div>
 ...
 <thead>
  ...
  <c:forEach  items="${inStockList}"  var="v">
       ...
       <td >${v.price}</td>
       <td >${v.operator}</td>
	    <c:set var="sum" value="${sum+v.quantity*v.price}"></c:set>
