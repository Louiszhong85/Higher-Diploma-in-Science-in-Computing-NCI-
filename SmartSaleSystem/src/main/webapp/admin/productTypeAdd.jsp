...
<body >
  ...
  <form name="form1" class="form-horizontal" id="form1" method="post" action="<%=path %>/productTypeAdd"><div class="layui-form-item">
	    <label class="layui-form-label">Type Name:</label>
    <div class="layui-input-block">
 		 <input type="text" name="typeName" id="typeName"   autocomplete="off" placeholder="Type Name" class="layui-input" style="width:300px" required="required" >
	    </div>
</div>
