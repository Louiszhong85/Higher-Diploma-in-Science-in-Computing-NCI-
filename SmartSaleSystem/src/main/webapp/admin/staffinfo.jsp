...
<body >
  ...
  <form name="form1" id="form1"  class="form-horizontal" method="post" action="<%=path %>/updateinfo?id=${staff.id}"><div class="layui-form-item">
	    <label class="layui-form-label">User Name:</label>
    <div class="layui-input-block">
 		 <input type="text" disabled name="username" id="username" class="layui-input" required="required" value="${staff.username}" readonly style="width:300px">	    </div>
</div>
 
<input  name="pwd" id="pwd"  value="${staff.pwd}"  type="hidden"   >	 
